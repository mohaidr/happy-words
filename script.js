...
const happyMessages = [
    ...
    { emoji: "👑", word: "{name} is ROYALTY!" },
    { emoji: "🧠", word: "{name} is SO CLEVER!" },
    { emoji: "💫", word: "{name} is OUT OF THIS WORLD!" },
    { emoji: "🎖️", word: "{name} deserves a GOLD MEDAL!" },
    { emoji: "🦸", word: "{name} is a SUPERHERO!" },
    { emoji: "📚", word: "{name} is an AMAZING learner!" },
    { emoji: "🤝", word: "{name} is a GREAT friend!" },
    { emoji: "🎤", word: "{name}'s voice MATTERS!" },
    { emoji: "🧩", word: "{name} solves problems like a PRO!" },
    { emoji: "🌟", word: "{name} is UNSTOPPABLE!" },
    { emoji: "🎓", word: "{name} is SO INTELLIGENT!" },
    { emoji: "💡", word: "{name} has BRILLIANT ideas!" },
    { emoji: "🏰", word: "{name} can build ANYTHING!" },
    { emoji: "🦅", word: "{name} will SOAR HIGH!" },
    { emoji: "🎊", word: "Everyone is PROUD of {name}!" },
    { emoji: "🌻", word: "{name} is BLOOMING beautifully!" },
    { emoji: "⚽", word: "{name} is a TEAM PLAYER!" },
    { emoji: "🎹", word: "{name} is TALENTED!" },
    { emoji: "🔥", word: "{name} is ON FIRE today!" },
    { emoji: "🥇", word: "{name} is NUMBER ONE!" },
    { emoji: "🌈", word: "{name} brings JOY everywhere!" },
    { emoji: "💪", word: "{name} never gives up!" },
    { emoji: "🐝", word: "{name} works SO HARD!" },
    { emoji: "🎯", word: "{name} always does their BEST!" },
    { emoji: "🦋", word: "{name} is TRANSFORMING into greatness!" },
    { emoji: "🌺", word: "{name} is ONE OF A KIND!" },
    { emoji: "🚂", word: "{name} keeps going STRONG!" },
    { emoji: "🎨", word: "{name} has an AMAZING imagination!" }
];
